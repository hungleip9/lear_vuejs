    ...
    <el-card>
      <el-image
        ...
        <div style="text-align: right; margin-top: 8px; margin-bottom: 24px">
            <el-link type="primary" style="text-align:right; color:#0080dd" @click="dangky">Quên mật khẩu?</el-link>
        </div>
        <el-button type="primary" :plain="true" @click="login">ĐĂNG NHẬP</el-button>
    </el-card>
  </div>
</template>
